...
export default function Home({ onContactClick }) {
	...
	return (
		<>
			...
			{/* Footer */}
			<footer ref={footerRef} style={{ position: 'sticky', bottom: 0, zIndex: 0, backgroundColor: 'var(--background-color)' }} className='border-t border-neutral-700 max-w-7xl mx-auto text-center pt-4 pb-2 px-4'>
				<div>
					...
					<span className='text-(--accent) text-5xl md:text-7xl lg:text-9xl font-black uppercase leading-[0.85]' style={{ display: 'inline-block', transform: 'scaleY(1.25)', transformOrigin: 'top' }}>
					...
					<div className='flex justify-center items-center mt-5 mb-8'>
						<a onClick={onContactClick} ref={buttonRef} className='z-10 flex items-center no-underline'>
							<Button className='group relative overflow-hidden font-bold flex items-center gap-2 px-4 py-2 md:px-3 md:py-2 cursor-pointer border-2 border-white transition-all duration-300 ease-out hover:scale-[1.03] active:scale-[0.98]' style={{ color: 'white', background: 'var(--background-color)', filter: 'drop-shadow(0px 0px 20px rgba(26, 26, 26, 0.8))' }}>
					...
					<div className='flex justify-center my-8'>
						<p className='text-white uppercase text-xs sm:text-sm font-semibold tracking-widest leading-relaxed max-w-md'>

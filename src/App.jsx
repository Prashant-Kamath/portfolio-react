...
function ContactModal({ show, onHide }) {
	...
	const inputClass =
		"w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm outline-none transition placeholder:text-white/30 focus:border-white/25 focus:bg-white/10";
	...
	return (
		...
		>
			...
			{/* Modal panel — xl, scrollable */}
			<div
				className="relative z-10 w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded-2xl border border-white/10 bg-[var(--white-to-black)] shadow-2xl backdrop-blur-md"
				...
				<div className="p-8 md:p-12">
					<div className="flex flex-col gap-12 lg:flex-row lg:items-start">
						...
						<div className="flex-1 lg:basis-7/12">
							<h2
								className="mb-8 text-3xl font-semibold leading-snug"
